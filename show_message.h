...
/*
 * This file declares all types of output functions,
 * in order to provide well-formatted messages that a front-end can understand
 *
 * Basically, all data go through stdout, and all message
 * (to user or to front-end) go through stderr
 *
 * In stderr:
 *  - all messages prefixed with 'error:' will be considered fatal error,
 *    front-end may notify user to re-start backend
 ...
 *
 *  To display message to user only, use show_user, nothing will be prepended,
 *  and the message will be ignore if scanmem is running as a backend
 */
