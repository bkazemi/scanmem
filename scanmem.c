...
bool sm_init(void)
{
    ...
    if (!vars->options.debug) {
        /* in debug mode, let it crash and see the core dump */
    ...
    sm_registercommand("set", handler__set, vars->commands,
                       SET_SHRTDOC,
                       SET_LONGDOC);
    sm_registercommand("list", handler__list, vars->commands,
                       LIST_SHRTDOC,
                       LIST_LONGDOC);
    sm_registercommand("delete", handler__delete, vars->commands,
                       DELETE_SHRTDOC,
                       DELETE_LONGDOC);
    sm_registercommand("reset", handler__reset, vars->commands,
                       RESET_SHRTDOC,
                       RESET_LONGDOC);
    sm_registercommand("pid", handler__pid, vars->commands,
                       PID_SHRTDOC,
                       PID_LONGDOC);
    ...
    sm_registercommand("=", handler__decinc, vars->commands,
                       NOTCHANGED_SHRTDOC,
                       NOTCHANGED_LONGDOC);
    sm_registercommand("!=", handler__decinc, vars->commands,
                       CHANGED_SHRTDOC,
    ...
    sm_registercommand("-", handler__decinc, vars->commands,
                       DECREASED_SHRTDOC,
                       DECREASED_LONGDOC);
    sm_registercommand("\"", handler__string, vars->commands,
                       STRING_SHRTDOC,
                       STRING_LONGDOC);
    sm_registercommand("update", handler__update, vars->commands,
                       UPDATE_SHRTDOC,
                       UPDATE_LONGDOC);
    sm_registercommand("exit", handler__exit, vars->commands,
                       EXIT_SHRTDOC,
                       EXIT_LONGDOC);
    ...
    sm_registercommand("help", handler__help, vars->commands,
                       HELP_SHRTDOC,
                       HELP_LONGDOC);
    sm_registercommand("shell", handler__shell, vars->commands,
                       SHELL_SHRTDOC, SHELL_LONGDOC);
    sm_registercommand("watch", handler__watch, vars->commands,
                       WATCH_SHRTDOC,
                       WATCH_LONGDOC);
    sm_registercommand("show", handler__show, vars->commands,
                       SHOW_SHRTDOC, SHOW_LONGDOC);
    sm_registercommand("dump", handler__dump, vars->commands,
                       DUMP_SHRTDOC, DUMP_LONGDOC);
    sm_registercommand("write", handler__write, vars->commands,
                       WRITE_SHRTDOC, WRITE_LONGDOC);
    sm_registercommand("option", handler__option, vars->commands,
                       OPTION_SHRTDOC, OPTION_LONGDOC);
    ...
    sm_registercommand(NULL, handler__default, vars->commands,
                       DEFAULT_SHRTDOC,
                       DEFAULT_LONGDOC);
